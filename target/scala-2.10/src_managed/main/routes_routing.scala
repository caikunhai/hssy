...
case controllers_OrderController_zxr53(params) => {
   call(params.fromQuery[String]("id", None), params.fromQuery[String]("doUser", None)) { (id, doUser) =>
        invokeHandler(controllers.OrderController.zxr(id, doUser), HandlerDef(this, "controllers.OrderController", "zxr", Seq(classOf[String], classOf[String]),"GET", """""", Routes.prefix + """order/zxr"""))
   }
}
